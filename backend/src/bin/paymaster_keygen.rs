//! Dev utility: generate a paymaster keypair for gasless (fee-sponsored) transfers.
//!
...
//!
//! The secret is the base58 keypair string [`solana_sdk::signature::Keypair`] reads back
//! with `from_base58_string`, matching how the backend loads it. Devnet only; do not print
//! or reuse a mainnet paymaster secret this way.
